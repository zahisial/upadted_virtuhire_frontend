      ...
      <div style={{ textAlign: 'center', maxWidth: '720px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link
            ...
            style={{ padding: '14px 32px', background: 'var(--gold)', border: '1px solid var(--gold)', color: 'var(--navy)', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}
          >
            {t('hero.cta1')}
          </Link>
          <Link
            href="/candidate?demo=true"
            style={{ padding: '14px 32px', border: '1px solid var(--border)', color: 'var(--white)', fontSize: '14px', textDecoration: 'none' }}
          >
            {t('hero.cta2')}
          </Link>
        </div>
